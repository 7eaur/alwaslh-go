...
p=Path(__file__).resolve().parents[1]/'CONTENT_RECONSTRUCTION_AUTOMATION_LOG.md'
...
text=text[:start]+active+text[sep:]
run='''
...
'''
if '## RUN 2026-09-14T10:11:00+03:00 — Worker B' not in text:
 text=text.rstrip()+run+'\n'
p.write_text(text,encoding='utf-8')
print('WORKER_B_SCIENCE_PART1_HANDOFF_RECORDED')
